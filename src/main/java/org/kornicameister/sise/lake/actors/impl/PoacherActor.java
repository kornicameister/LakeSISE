...
public class PoacherActor extends Actor {
    public PoacherActor(final String name, final Double moveRange) {
        super(name, moveRange);
    }

    public PoacherActor(final String name, final Double moveRange, final Point location) {
